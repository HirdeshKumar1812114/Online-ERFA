...
const Layout = (props) => {
  ...
  useEffect(() => {
    ...
    api.get(`officer/details/${localStorage.getItem('userUpdate')}`)
      .then(res => {
  ...
  return (
    <CContainer fluid>
      <CCard>
        <CCardHeader>
          <strong><h3>Update User Form</h3></strong>
        </CCardHeader>
        <CCardBody>
          ...
          {loading == true ?
            ...
            >
              ...
              <CCol xs={6}>
                ...
                <CFormInput disabled value={usertoUpdate.nic} id="inputNic" placeholder="XXXX-XXXXXXX-X (13-digits with dashes)"
                />
              </CCol>
              ...
              <CCol md={6}>
                ...
                <CFormInput disabled value={usertoUpdate.dob} id="inputDob" type="date"
                />
              </CCol>

              <CCol md={6}>
                <CFormLabel htmlFor="designation">Designation</CFormLabel>
                <CFormInput value={Newdesignation} type="text" id="designation" placeholder={designation}
                  onChange={
                    (e) => { setNewDesignation(e.target.value) }
                  }
                />
              </CCol>
              <CCol md={6}>
                <CFormLabel htmlFor="inputCellNo">Cell Number</CFormLabel>
                <CFormInput value={NewcellNumber} type="number" id="inputCellNo" placeholder={cellNumber}
                  onChange={
                    (e) => { setNewCellNumber(e.target.value) }
                  }
                />
              </CCol>
